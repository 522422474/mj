    ...
    function constructor() {
        return {
            ...
            requestOperation_CC: function (operation,cards,isZiMoHuOnly,callback) {
                var self = this;
                GameNet.getInstance().request("room.changChuMahjongHandler.operationReq", {operation:operation,cards:cards,isZiMoHuOnly:isZiMoHuOnly}, function (rtn) {
            ...
            requestDisCard_CC: function (card, callback) {
                var self = this;
                GameNet.getInstance().request("room.changChuMahjongHandler.playCardsReq", {cards:card }, function (rtn) {
            ...
            requestPass_CC: function (operation,cards,mcallback) {
                var self = this;
                GameNet.getInstance().request("room.changChuMahjongHandler.operationReq", {operation:operation,cards:cards}, function (rtn) {
