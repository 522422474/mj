...
var SoundMngr = cc.Class({
    ...
    playAudioChat: function (data, sex) {
        ...
        if( GameData.client.gameType == gameDefine.GameType.Game_Mj_Tianjin) {
            ...
            || GameData.client.gameType == gameDefine.GameType.Game_Niu_Niu_10) {
            cc.log("..niuniu");
            if (sex == 1) {
            ...
            cc.log("..ZJH");
            if (sex == 1) {
                LanguagePath = 'resources/zjh/sound/man/';
            }else{
                LanguagePath = 'resources/zjh/sound/women/';
            }
        }
    ...
    playNiuNiuAudio : function (pokerType, sex) {
        ...
        if (pokerType == -5) {
            audioUrl = 'resources/sound/niuniu/jinbi.mp3'
        }
        if (pokerType == -6) {
            audioUrl = 'resources/sound/niuniu/lunzhuang.mp3'
        }
        if (pokerType == -7) {
            audioUrl = 'resources/sound/niuniu/dingzhuang.mp3'
        }
    ...
    playAudioZJH: function (soundName, sex) {
        var resAudio = '';
        if (sex != null) {
            if (sex == 1) {
                resAudio += 'man/';
        ...
        // switch (soundName) {
        //     case 'start': resAudio += 'start'; break;
        //     case 'card': resAudio += 'card'; break;
        //     case 'chip_add': resAudio += 'chip_add'; break;
        //     case 'get_chip': resAudio += 'get_chip'; break;
        //     case 'compare': resAudio += 'compare'; break;
        //     case 'shengli': resAudio += 'sthengli'; break;
        //     case 'shibai': resAudio += 'shibai'; break;
        //     case 'fanpai': resAudio += 'fanpai'; break;
        //     case 'giveUp1': resAudio += 'giveUp1'; break;
        //     case 'giveUp2': resAudio += 'giveUp2'; break;
        //     case 'follow1': resAudio += 'follow1'; break;
        //     case 'follow2': resAudio += 'follow2'; break;
        //     case 'cmp': resAudio += 'cmp'; break;
        //     case 'addChip': resAudio += 'addChip'; break;
        //     default: return;
        // }
        resAudio += soundName;
        var audioDis = new cc.AudioSource();
    ...
    playTableDynAudio: function(key, type){
        ...
        var str1 = undefined,
            str2 = undefined;
        switch (parseInt(key)){
            case 0:{ str1 = 'FW_'; }break;
            case 1:{ str1 = 'ZD_'; }break;
            case 2:{ str1 = 'JD_'; }break;
            case 3:{ str1 = 'MG_'; }break;
            case 4:{ str1 = 'BZ_'; }break;
            case 5:{ str1 = 'PJ_'; }break;
        }
        switch (parseInt(type)){
            case 0:{ str2 = 'feixing' }break;
            case 1:{ str2 = 'xiaoguo' }break;
        }
    ...
    /*--------------------百人牛牛音效--------------------*/
    playHundredOther: function(type){
        var resAudio = '';
        switch(type){
            case 'fapai': resAudio = 'fapai'; break;
            case 'chouma': resAudio = 'chouma'; break;
            case 'result': resAudio = 'coinsfly'; break;
            case 'winsign': resAudio = 'winsign'; break;
            case 'stop': resAudio = 'tingzhixiazhu'; break;
            case 'start': resAudio = 'kaishixiazhu'; break;
            case 'countDown': resAudio = 'daojishi'; break;
            case 'baozhuang': resAudio = 'baozhuang'; break;
            case 'guide': resAudio = 'shensuanzibaoxing'; break;
            case 'shangzhuang': resAudio = 'shangzhuang'; break;
            case 'zhuangWin': resAudio = 'zhuangjiatongchi'; break;
            case 'zhuangLose': resAudio = 'zhuangjiatongpei'; break;
        }
        var audioDis = new cc.AudioSource();
