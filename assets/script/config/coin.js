...
var TestConfig = {
  gameName: "若宇摸摸麻将",  //游戏名称
  areaType: gameDefine.AreaType.Area_Coin, //地区
  serverIP:"coin.mahjong.ry-play.com",  
  // serverIP: "101.200.63.118",

  serverPort:3310,  //端口
  versionText: "测试服版本",  //版号内r容
  notice: "抵制不良游戏，拒绝盗版游戏，注意自我保护，谨防受骗上当。适度游戏益脑，沉迷游戏伤身，合理安排时间，享受健康生活.",
  wxShareUrl: "https://fir.im/coin1",  //暂用天津
  ...
  serverConfig: {
      //匹配金币场
      "matchCoin": {
          "1": {"name":"天津麻将匹配局", "roundType":1, "roundMax":1, "joinerMax":4, "cost":[100,300,1000],"enter":[5000,15000,100000]},
          "5": {"name":"牛牛匹配局", "roundType":1, "roundMax":-1, "joinerMax":6, "cost":[50,300,2000], "enter":[2000,15000,100000]},
          ...
          "8": {"name":"天津斗地主匹配局", "roundType":1, "roundMax":1, "joinerMax":3, "cost":[100,300,1000], "enter":[2000,15000,100000]},
          ...
          "102": {"name":"经典斗地主匹配局", "roundType":1, "roundMax":1, "joinerMax":3, "cost":[100,500,2000], "enter":[2000,10000,50000]},
          "103": {"name":"三张牌匹配局", "roundType":1, "roundMax":1, "joinerMax":6, "cost":[50,300,2000], "enter":[20000,100000,500000]},
      },
      //比赛场
      "fight": {},
    //金币
