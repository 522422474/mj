...
configMgr.init = function(){
  ...
  // var curType = gameDefine.AreaType.Area_Coin;
  switch(curType){
    ...
    case gameDefine.AreaType.Area_Appstore: this.m_cur_config = require('appstore'); break;
    case gameDefine.AreaType.Area_Coin: this.m_cur_config = require('coin'); break;
  }
}
