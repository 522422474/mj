...
cc.Class({
    ...
    onLoad: function () {
        ...
        //注册监听
        require('util').registEvent('ddz-onGameStart', this, this.showTableLayer);
        require('util').registEvent('openScore', this, this.showTableLayer);
        require('util').registEvent('cardChange', this, this.roomcardRefresh);
        //require('util').registEvent('joinClubSuc',this,this.joinClubSuc);
        require('util').registEvent('refreshUIClubData', this, this.clubDataRefresh);
        //require('util').registEvent('refreshAgentRoomBtn',this,this.refreshAgentRoomBtn);
        require('util').registEvent('refreshUIClubInvite', this, this.showHint);
        require('util').registEvent('refreshCreateOrBackBtn', this, this.refreshCreateOrBackBtn);
