...
cc.Class({
    ...
    onLoad: function () {
        ...
        require('util').registEvent('pdk-onReady', this, this.onReady);
        require('util').registEvent('onCreatorQuit', this, this.onCreatorQuit);
        require('util').registEvent('rotateAction', this, this.rotateAction);
        ...
        require('util').registEvent('pdk-onGameAllScore', this, this.onGameAllScoreHandler);
        require('util').registEvent('pdk-onGameStart', this, this.onGameStartHandler);
        ...
        require('util').registEvent('pdk-showKicking', this, this.showKicking);
    ...
    onDestroy: function () {
        ...
        unrequire('util').registEvent('pdk-onReady', this, this.onReady);
        unrequire('util').registEvent('onCreatorQuit', this, this.onCreatorQuit);
        unrequire('util').registEvent('rotateAction', this, this.rotateAction);
        ...
        unrequire('util').registEvent('pdk-onGameAllScore', this, this.onGameAllScoreHandler);
        unrequire('util').registEvent('pdk-onGameStart', this, this.onGameStartHandler);
        unrequire('util').registEvent('onRoomReadyInfo', this, this.onRoomReadyInfoHandler);
        unrequire('util').registEvent('pdk-onGameScore', this, this.onGameScoreHandler);
        ...
        unrequire('util').registEvent('pdk-showKicking', this, this.showKicking);
