...
cc.Class({
    ...
    onLoad: function () {
        require('util').registEvent('pdk-onGameStart', this, this.showTableLayer);
        //require('util').registEvent('ddz-onGameScore', this, this.showResultLayer);
        ...
        require('util').registEvent('AnimationDelayTime', this, this.showResultLayer);
        ...
        // }
        // this.tableUI[0].active = true;
        // this.tableUI[1].active = true;
        this.showTableUI(true);
    },

    onDestroy: function () {
        unrequire('util').registEvent('pdk-onGameStart', this, this.showTableLayer);
        //unrequire('util').registEvent('ddz-onGameScore', this, this.showResultLayer);
        ...
        unrequire('util').registEvent('AnimationDelayTime', this, this.showResultLayer);
