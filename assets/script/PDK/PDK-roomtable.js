...
var roomTable = cc.Class({
    ...
    registListenr: function () {
        ...
        require('util').registEvent('pdk-onGameInfo', this, this.onShow);
        require('util').registEvent('showFirstCard', this, this.showZhuangInfo);
        require('util').registEvent('pdk-initCardHands', this, this.onShow);
        require('util').registEvent('pdk-initCardHand', this, this.initCardHand);
        // require('util').registEvent('pdk-initCardHandNum', this, this.showCards);
        require('util').registEvent('pdk-initCardHandNum', this, this.showCardNum);
        require('util').registEvent('pdk-initCardHandNums', this, this.showCardNum);
        require('util').registEvent('pdk-onGameStart', this, this.handleGameStart);
        require('util').registEvent('pdk-onShowObtainNode', this, this.showObtainNode);
        require('util').registEvent('pdk-showDisPoker', this, this.showDisPoker);
        require('util').registEvent('initTableNode', this, this.initTableNode);
        require('util').registEvent('pdk-onGameScore', this, this.showWinNode);
        require('util').registEvent('pdk-cardWarning', this, this.showWarningNode);
        require('util').registEvent('pdk-onDiscardType', this, this.showDisCardType);
        require('util').registEvent('pdk-disPokerArry', this, this.setDisPokerArry);
        require('util').registEvent('pdk-passcb', this, this.playPassEffect);
        require('util').registEvent('pdk-hintCard', this, this.showHintCard);
        require('util').registEvent('pdk-hideCard', this, this.hidePlayerCard);
        require('util').registEvent('onShowSummary', this, this.stopClockMusic);
        require('util').registEvent('pdk-showWatch', this, this.showWatch);
        require('util').registEvent('pdk-reconnectionInfo', this, this.reconnectionInfo);
        require('util').registEvent('runFlipAction', this, this.runFlipAction);
        require('util').registEvent('initObtainNode', this, this.initObtainNode);
        require('util').registEvent('showDisBtnAndClook', this, this.showDisBtnAndClook);
    ...
    onDestroy: function () {
        ...
        unrequire('util').registEvent('pdk-onGameInfo', this, this.onShow);
        unrequire('util').registEvent('showFirstCard', this, this.showZhuangInfo);
        unrequire('util').registEvent('pdk-initCardHands', this, this.onShow);
        unrequire('util').registEvent('pdk-initCardHand', this, this.initCardHand);
        // unrequire('util').registEvent('pdk-initCardHandNum', this, this.showCards);
        unrequire('util').registEvent('pdk-initCardHandNum', this, this.showCardNum);
        unrequire('util').registEvent('pdk-initCardHandNums', this, this.showCardNum);
        unrequire('util').registEvent('pdk-onGameStart', this, this.handleGameStart);
        unrequire('util').registEvent('pdk-onShowObtainNode', this, this.showObtainNode);
        unrequire('util').registEvent('pdk-showDisPoker', this, this.showDisPoker);
        unrequire('util').registEvent('initTableNode', this, this.initTableNode);
        unrequire('util').registEvent('pdk-onGameScore', this, this.showWinNode);
        unrequire('util').registEvent('pdk-cardWarning', this, this.showWarningNode);
        unrequire('util').registEvent('pdk-onDiscardType', this, this.showDisCardType);
        unrequire('util').registEvent('pdk-disPokerArry', this, this.setDisPokerArry);
        unrequire('util').registEvent('pdk-passcb', this, this.playPassEffect);
        unrequire('util').registEvent('pdk-hintCard', this, this.showHintCard);
        unrequire('util').registEvent('pdk-hideCard', this, this.hidePlayerCard);
        unrequire('util').registEvent('onShowSummary', this, this.stopClockMusic);
        unrequire('util').registEvent('pdk-showWatch', this, this.showWatch);
        unrequire('util').registEvent('pdk-reconnectionInfo', this, this.reconnectionInfo);
        unrequire('util').registEvent('runFlipAction', this, this.runFlipAction);
        unrequire('util').registEvent('initObtainNode', this, this.initObtainNode);
        unrequire('util').registEvent('showDisBtnAndClook', this, this.showDisBtnAndClook);
