...
var roomTable = cc.Class({
    ...
    registListenr: function () {
        ...
        require('util').registEvent('onPlayerInitScore',this,this.basicScore);
        require('util').registEvent('onPlayerCards', this, this.onShow);
        require('util').registEvent('onActionBtn',this,this.showObtainNode);
        require('util').registEvent('onTurner',this,this.initBtn);
        require('util').registEvent('onTurnerAction',this,this.otherActionEffect);
        require('util').registEvent('onGameResult',this,this.gameResult);
        require('util').registEvent('onPrepareInfo', this, this.initUI);
        require('util').registEvent('onIncScore', this, this.addChips);
        require('util').registEvent('onDropPlayerInfo', this, this.showConnectDrop);
    },

    onDestroy: function () {
        unrequire('util').registEvent('onPlayerInitScore',this,this.basicScore);
        unrequire('util').registEvent('onPlayerCards', this, this.onShow);
        unrequire('util').registEvent('onActionBtn',this,this.showObtainNode);
        unrequire('util').registEvent('onTurner',this,this.initBtn);
        unrequire('util').registEvent('onTurnerAction',this,this.otherActionEffect);
        unrequire('util').registEvent('onGameResult',this,this.gameResult);
        unrequire('util').registEvent('onPrepareInfo', this, this.initUI);
        unrequire('util').registEvent('onIncScore', this, this.addChips);
        unrequire('util').registEvent('onDropPlayerInfo', this, this.showConnectDrop);
    },
