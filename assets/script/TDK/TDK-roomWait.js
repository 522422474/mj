...
cc.Class({
    ...
    onLoad: function () {
        ...
        require('util').registEvent('onTurner',this,this.onGameTurn);
        ...
        require('util').registEvent('onPlayerIncScore', this, this.initPlayers);
        require('util').registEvent('yunwaUploaded', this, this.onYunwaUploaded);
        require('util').registEvent('onIncScore', this, this.getConnectChipsScore);
        require('util').registEvent('onPlayerIncScore',this,this.getEveryOneScore);
        require('util').registEvent('onPlayerInitScore',this,this.getEveryOneScore);
    ...
    onDestroy: function () {
        ...
        unrequire('util').registEvent('onTurner',this,this.onGameTurn);
        unrequire('util').registEvent('onPlayerIncScore',this,this.getEveryOneScore);
        unrequire('util').registEvent('onPlayerInitScore',this,this.getEveryOneScore);
