...
cc.Class({
    ...
    onLoad: function () {
        ...
        require('util').registEvent('onRoomDissolve', this, this.onRoomDissolveHandler);
        require('util').registEvent('showDissolve', this, this.showDissolveLayer);
    },
    
    onDestroy: function () {
        unrequire('util').registEvent('onRoomInfo', this, this.onRoomInfoHandler);
        unrequire('util').registEvent('onRoomDissolve', this, this.onRoomDissolveHandler);
        unrequire('util').registEvent('showDissolve', this, this.showDissolveLayer);
    },
        ...
        if (dissolveData.isStart == false) {
            ...
            setTimeout(function(){
                if (GameData.roomClose) {
                    sendEvent('onShowView', 'summaryView');
                }
            }, 100);
        }
    },
