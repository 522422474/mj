...
cc.Class({
    ...
    onLoad: function () {
        ...
        require('util').registEvent('onRoomChat', this, this.onSSSChatHandler);
        require('util').registEvent('onRoomDissolve', this, this.showdissolveLayer);
    ...
    onDestroy: function() {
        unrequire('util').registEvent('onRoomChat', this, this.onSSSChatHandler);
