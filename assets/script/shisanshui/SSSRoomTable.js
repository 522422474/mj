...
var SSSRoomTable =  cc.Class({
    ...
    onLoad: function () {
        ...
        require('util').registEvent('13-RoomBaseInfo', this, this.showPlayers);
        require('util').registEvent('13-GameStart',this,this.showCards);
        require('util').registEvent('onRoomReadyInfo',this,this.showReadyInfo);
        require('util').registEvent('13-ShowReadyUI', this, this.showReady);
        require('util').registEvent('13-PlayerCards', this, this.refreshCard);
        require('util').registEvent('13-RoomResult', this, this.showRoomResult);
        require('util').registEvent('13-Discard', this, this.showDisCardReady);
        require('util').registEvent('13-GameEnd', this, this.showGameEnd);
        ...
        require('util').registEvent('13-DiscardInfo', this, this.showConnectDisCardInfo);
        require('util').registEvent('13-SelfDiscard', this, this.showConnectDisCard);
        require('util').registEvent('againReady', this, this.againReady);
    ...
    onDestroy: function() {
        ...
        unrequire('util').registEvent('13-RoomBaseInfo', this, this.showPlayers);
        unrequire('util').registEvent('13-GameStart',this,this.showCards);
        unrequire('util').registEvent('onRoomReadyInfo', this, this.showReadyInfo);
        unrequire('util').registEvent('13-ShowReadyUI', this, this.showReady);
        unrequire('util').registEvent('13-PlayerCards', this, this.refreshCard);
        unrequire('util').registEvent('13-RoomResult', this, this.showRoomResult);
        unrequire('util').registEvent('13-Discard', this, this.showDisCardReady);
        unrequire('util').registEvent('13-GameEnd', this, this.showGameEnd);
        ...
        unrequire('util').registEvent('13-DiscardInfo', this, this.showConnectDisCardInfo);
        unrequire('util').registEvent('13-SelfDiscard', this, this.showConnectDisCard);
        unrequire('util').registEvent('againReady', this, this.againReady);
    ...
    wxInviteBtnClicked: function() {
        ...
        if(GameData13.room.costType == 4) {
            title = "十三水 " +"(代开)"+"房间号:"+GameData.player.roomid;
        }
        var des = this.getInviteStr();
