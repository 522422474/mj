...
cc.Class({
    ...
    onLoad: function () {
        ...
        //require('util').registEvent('recordInfo', this.recordInfoShow);
    },

    onDestroy: function () {
        unrequire('util').registEvent('onShowSummary', this, this.onShow);
        //unrequire('util').registEvent('recordInfo', this.recordInfoShow);
    },
    ...
    showPlayer: function (player, idx) {
        ...
        if (RoomHandler.scores[GetScoreMaxUid()] == RoomHandler.scores[player.uid] && RoomHandler.scores[GetScoreMaxUid()] > 0) {
            ...
            winNode.active = true;
            winNode.scale = 2;
            var act1 = cc.rotateBy(0.4,720);
            var act2 = cc.scaleTo(0.4,1);
