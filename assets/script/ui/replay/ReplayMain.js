...
cc.Class({
    ...
    onLoad: function () {
        ...
        require('util').registEvent('tjddz-onGameStart', this, this.showTableLayer);
    ...
    onDestroy: function () {
        ...
        unrequire('util').registEvent('ddz-onGameStart', this, this.showTableLayer);
        unrequire('util').registEvent('tjddz-onGameStart', this, this.showTableLayer);
        ...
        if (this._actionIndex < ReplayData.actions.length) {
            ...
            for (var i = 0; i < this.playerCardNodes.length; i++) {
                ...
                if (playerCards.uid == cardController.uid) {
                    if (i == 0 && ReplayData.result.winner > 0) {
