...
var agentPanel = cc.Class({
    ...
    registerListener : function(){
        require('util').registEvent('refreshAgentRoomUINew',this,this.refreshUINew);
        require('util').registEvent('refreshAgentRoomUIResult',this,this.refreshUIResult);
    },

    onDestroy : function(){
        unrequire('util').registEvent('refreshAgentRoomUINew',this,this.refreshUINew);
        unrequire('util').registEvent('refreshAgentRoomUIResult',this,this.refreshUIResult);
    },
	...
	initItemChildNode: function (item,data) {
        if(item == undefined || data == undefined){
            return;
        }
