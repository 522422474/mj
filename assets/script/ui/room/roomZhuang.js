...
cc.Class({
    ...
    onLoad: function () {
        ...
        require('util').registEvent('onZhuang', this, this.onZhuangHandler);
        require('util').registEvent('onSelectZhuang', this, this.showZuoZhuang);
        require('util').registEvent('onSelectLazhuang', this, this.showLaZhuang);
        require('util').registEvent('onSelectZhuangAgain', this, this.showZhuangAgain);
        require('util').registEvent('onSelectLazhuangAgain', this, this.showLaZhuangAgain);
        require('util').registEvent('initZhuangInfo', this, this.close);
        require('util').registEvent('onSelectZhuangInfo', this, this.onSelectZhuangInfo);
        require('util').registEvent('initCards', this, this.onCloseZhuang);
    ...
    onDestroy: function () {
        ...
        unrequire('util').registEvent('onZhuang', this, this.onZhuangHandler);
        unrequire('util').registEvent('onSelectZhuang', this, this.showZuoZhuang);
        unrequire('util').registEvent('onSelectLazhuang', this, this.showLaZhuang);
        unrequire('util').registEvent('onSelectZhuangAgain', this, this.showZhuangAgain);
        unrequire('util').registEvent('initZhuangInfo', this, this.close);
            ...
            if (joiner != null) {
                ...
                if (num > 0) {
                    if (zhuangid == uid && GameData.room.opts.lazhuang == 1) {
                        ...
                        this.showHeaderButtom(index, 'la1');
                    } else if (num == 2) {
                        this.showHeaderButtom(index, 'la2');
                    }
                } else if (num == 0) {
                    var zuoNode = cc.find('header_' + index + '/zuo1', this.headerNode.parent);
                    if (zuoNode.active == false) {
                        this.showHeaderButtom(index, 'bulazhuang');
                    }
                } else {
                    needTizhuang = false;
                    this.hideHeaderButtom(index);
    ...
    showLaZhuangAgain: function (data) {
        ...
        //if (GameData.room.lazhuang != 2) return;
        if (data.detail.uid == undefined) return;
