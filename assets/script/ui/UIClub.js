...
cc.Class({
    ...
    registerListener: function () {
        require('util').registEvent('refreshUIClubData', this, this.refreshUIMyClub);
        require('util').registEvent('refreshUIClubInvite', this, this.refreshUIApplyClub);
        require('util').registEvent('refreshUIClubApply', this, this.refreshUIApplyClub);
    },
