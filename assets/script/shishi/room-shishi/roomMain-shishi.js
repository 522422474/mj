...
cc.Class({
    ...
    onLoad: function () {
        ...
        require('util').registEvent('startWater', this, this.openUIChaShui);
        require('util').registEvent('initCards', this, this.closeUIChaShui);
    ...
    onDestroy: function() {
        ...
        unrequire('util').registEvent('startWater', this, this.openUIChaShui);
        unrequire('util').registEvent('initCards', this, this.closeUIChaShui);
