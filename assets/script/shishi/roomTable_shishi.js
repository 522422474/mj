...
var roomTable = cc.Class({
    ...
    onLoad: function () {
        //require('util').registEvent('onRoomMsg', this, this.showPlayers);
        ...
        require('util').registEvent('initCardHua',this,this.showHuaAction);
        ...
        require('util').registEvent('onYoujin', this, this.showCards);
        ...
        require('util').registEvent('allYoujinInfo', this, this.allYouJinShow);
        require('util').registEvent('startWater', this, this.showChaShuiLayer());
        // require('util').registEvent('allYoujinInfo', this, this.allYoujinInfo);
    ...
    onDestroy: function() {
        //unrequire('util').registEvent('onRoomMsg', this, this.showPlayers);
        ...
        unrequire('util').registEvent('initCardHua',this,this.showHuaAction);
        ...
        unrequire('util').registEvent('onYoujin', this, this.showCards);
        ...
        unrequire('util').registEvent('allYoujinInfo', this, this.allYouJinShow);
        unrequire('util').registEvent('startWater', this, this.showChaShuiLayer);
        // unrequire('util').registEvent('allYoujinInfo', this, this.allYoujinInfo);
