...
cc.Class({
    ...
    registListenr: function () {
        ...
        require('util').registEvent('zhaJinHua-onGameInfo', this, this.onGameTurn);
        require('util').registEvent('onZhaJinHuaRunEnd', this, this.showReadyNode);
        require('util').registEvent('onReadyCountDown',this,this.onReadyCountDown);
        ...
        require('util').registEvent('zhaJinHua-onGameStart', this, this.onGameStartHandler);
    },
    ...
    onDestroy: function () {
        ...
        unrequire('util').registEvent('zhaJinHua-onGameInfo', this, this.onGameTurn);
        unrequire('util').registEvent('onZhaJinHuaRunEnd', this, this.showReadyNode);
        unrequire('util').registEvent('onReadyCountDown',this,this.onReadyCountDown);
        ...
        unrequire('util').registEvent('zhaJinHua-onGameStart', this, this.onGameStartHandler);
    },
