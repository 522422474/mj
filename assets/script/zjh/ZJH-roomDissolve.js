...
cc.Class({
    ...
    onLoad: function () {
        this.initHeaderUI();
        require('util').registEvent('onRoomDissolve', this, this.showDissolveText);
        ...
        require('util').registEvent('onJoinerConnect', this, this.showHeaderConnect);
    },

    onDestroy: function () {
        unrequire('util').registEvent('onRoomDissolve', this, this.showDissolveText);
        unrequire('util').registEvent('onJoinerLost', this, this.showJoinerLost);
        unrequire('util').registEvent('onJoinerConnect', this, this.showHeaderConnect);
    },
    ...
    showPlayers: function () {
        ...
        //    playerArr = GameData.joiners;
        //}else{
        //    playerArr = RoomHandler.getPlayGamePlayerArr();
        //}
        //playerArr = GameData.joiners;
        for (var i = 0; i < GameData.joiners.length; i++) {
            var index = i + 1;
            //var joiner = GameData.getPlayerByUid(playerArr[i]);
            //if (GameData.room.status == gameDefine.RoomState.WAIT) {
            //    joiner = GameData.joiners[i];
            //}
