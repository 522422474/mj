...
cc.Class({
    ...
    onLoad: function () {
        ...
        require('util').registEvent('onStarPiao',this,this.UIControl);
        require('util').registEvent('onMahjongRunEnd',this,this.ShowUI);
    ...
    onDestroy: function () {
        unrequire('util').registEvent('onStarPiao', this, this.UIControl);
        unrequire('util').registEvent('onMahjongRunEnd',this,this.ShowUI);
    },
