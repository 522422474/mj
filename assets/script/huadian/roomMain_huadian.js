...
cc.Class({
    ...
    onLoad: function () {
        ...
        require('util').registEvent('onGameReady', this, this.showTableLayer);
        //小结算
        require('util').registEvent('onMahjongRunEnd', this, this.showResultLayer);
        //重连
        require('util').registEvent('onHuaDianMahjongReconnecet', this, this.showTableLayer);
        ...
        require('util').registEvent('onStarPiao', this, this.openUIPiao);
        require('util').registEvent('initCards', this, this.closeUIPiao);
        ...
        if (GameData.room.opts) {
            playStr = getRuleStrHd(GameData.room.opts);
        }
    ...
    onDestroy: function () {
        ...
        unrequire('util').registEvent('onHuaDianMahjongReconnecet', this, this.showTableLayer);
        ...
        unrequire('util').registEvent('onStarPiao', this, this.openUIPiao);
        unrequire('util').registEvent('initCards', this, this.closeUIPiao);
    ...
    openUIPiao: function () {
        ...
        //cc.log('profileHuaDian.PiaoInfo.runState:'+profileHuaDian.PiaoInfo.runState);
        if (profileHuaDian.PiaoInfo.runState > HuaDian.RunStateEmnum.PIAO){
    ...
    showSettingLayer: function (evt, data) {
        if (data == 1) {
            ...
            openView('SettingsPanel_HD',gameDefine.GameType.Game_MJ_HuaDian);
        } else {
