...
var roomTable = cc.Class({
    ...
    registListenr: function () {
        require('util').registEvent('onPrepareInfo', this, this.showRoomRule);
        require('util').registEvent('tjddz-onGameInfo', this, this.onShow);
        require('util').registEvent('tjddz-onDiZhu', this, this.showDizhuInfo);
        require('util').registEvent('tjddz-initCardHands', this, this.onShow);
        require('util').registEvent('tjddz-initCardHand', this, this.initCardHand);
        // require('util').registEvent('tjddz-initCardHandNum', this, this.showCards);
        require('util').registEvent('tjddz-initCardHandNum', this, this.showCardNum);
        require('util').registEvent('tjddz-initCardHandNums', this, this.showCardNum);
        require('util').registEvent('tjddz-onGameStart', this, this.handleGameStart);
        require('util').registEvent('tjddz-onJiaoFen', this, this.showJiaoFenNode);
        require('util').registEvent('tjddz-jiaoFencb', this, this.playJiaofenEffect);
        require('util').registEvent('tjddz-onShowObtainNode', this, this.showObtainNode);
        require('util').registEvent('tjddz-showDisPoker', this, this.showDisPoker);
        require('util').registEvent('initTableNode', this, this.initTableNode);
        require('util').registEvent('tjddz-onGameScore', this, this.showWinNode);
        require('util').registEvent('tjddz-cardWarning', this, this.showWarningNode);
        require('util').registEvent('tjddz-onDiscardType', this, this.showDisCardType);
        require('util').registEvent('tjddz-disPokerArry', this, this.setDisPokerArry);
        require('util').registEvent('tjddz-passcb', this, this.playPassEffect);
        require('util').registEvent('tjddz-hintCard', this, this.showHintCard);
        require('util').registEvent('tjddz-hideCard', this, this.hidePlayerCard);
        require('util').registEvent('onShowSummary', this, this.stopClockMusic);
        require('util').registEvent('tjddz-startTi', this, this.showTiChuai);
        require('util').registEvent('tjddz-startChuai', this, this.showTiChuai);
        require('util').registEvent('tjddz-showKicking', this, this.showKicking);
        require('util').registEvent('tjddz-showWatch', this, this.showWatch);
        require('util').registEvent('tjddz-reconnectionInfo', this, this.reconnectionInfo);
        require('util').registEvent('coinEndEvent', this, this.coinEndEvent);
    ...
    onDestroy: function () {
        unrequire('util').registEvent('onPrepareInfo', this, this.showRoomRule);
        unrequire('util').registEvent('tjddz-onGameInfo', this, this.onShow);
        unrequire('util').registEvent('tjddz-onDiZhu', this, this.showDizhuInfo);
        unrequire('util').registEvent('tjddz-initCardHands', this, this.onShow);
        unrequire('util').registEvent('tjddz-initCardHand', this, this.initCardHand);
        // unrequire('util').registEvent('tjddz-initCardHandNum', this, this.showCards);
        unrequire('util').registEvent('tjddz-initCardHandNum', this, this.showCardNum);
        unrequire('util').registEvent('tjddz-initCardHandNums', this, this.showCardNum);
        unrequire('util').registEvent('tjddz-onGameStart', this, this.handleGameStart);
        unrequire('util').registEvent('tjddz-onJiaoFen', this, this.showJiaoFenNode);
        unrequire('util').registEvent('tjddz-jiaoFencb', this, this.playJiaofenEffect);
        unrequire('util').registEvent('tjddz-onShowObtainNode', this, this.showObtainNode);
        unrequire('util').registEvent('tjddz-showDisPoker', this, this.showDisPoker);
        unrequire('util').registEvent('initTableNode', this, this.initTableNode);
        unrequire('util').registEvent('tjddz-onGameScore', this, this.showWinNode);
        unrequire('util').registEvent('tjddz-cardWarning', this, this.showWarningNode);
        unrequire('util').registEvent('tjddz-onDiscardType', this, this.showDisCardType);
        unrequire('util').registEvent('tjddz-disPokerArry', this, this.setDisPokerArry);
        unrequire('util').registEvent('tjddz-passcb', this, this.playPassEffect);
        unrequire('util').registEvent('tjddz-hintCard', this, this.showHintCard);
        unrequire('util').registEvent('tjddz-hideCard', this, this.hidePlayerCard);
        unrequire('util').registEvent('onShowSummary', this, this.stopClockMusic);
        unrequire('util').registEvent('tjddz-startTi', this, this.showTiChuai);
        unrequire('util').registEvent('tjddz-startChuai', this, this.showTiChuai);
        unrequire('util').registEvent('tjddz-showKicking', this, this.showKicking);
        unrequire('util').registEvent('tjddz-showWatch', this, this.showWatch);
        unrequire('util').registEvent('tjddz-reconnectionInfo', this, this.reconnectionInfo);
        unrequire('util').registEvent('coinEndEvent', this, this.coinEndEvent);
