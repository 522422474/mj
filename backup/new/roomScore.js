cc.Class({
    ...
    onLoad: function () {
        ...
        if (GameData.room) {
            this.playerMax = GameData.room.joinermax;
        }
        //this.playerMax = GameData.room.joinermax;
        require('util').registEvent('onRoomInfo', this, this.ShowsPlayerTitle);
        // require('util').registEvent('onGameAllScore',this,this.AddSumScore);
    },
    onEnable: function () {
        if (GameData.joiners) {
    ...
    onDestroy: function () {
        unrequire('util').registEvent('onRoomInfo', this, this.ShowsPlayerTitle);
        // unrequire('util').registEvent('onGameScore', this, this.ShowPlayerScoreItme);
        // unrequire('util').registEvent('onGameAllScore',this,this.AddSumScore);
    },
